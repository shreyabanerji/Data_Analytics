...
#correlation cutoff
#Reference : https://stackoverflow.com/questions/18275639/remove-highly-correlated-variables#Ref: https://stackoverflow.com/questions/5863097/selecting-only-numeric-columns-from-a-data-frame
#<br>
 # Looking at the data, we can say that we can safely drop SqFootage, TotRmsAbvGrd as they have a very high correlation 
...
#<br> b)An ideal residual plot should not have any trend or any outliers. 
      #Here, most of the point are concentrated around the zero but one point is far away(outlier).<br>
...
#<br>The residual plot of linear model2(i.e,after applying log transformation) does not show any trend. 
#It is more scattered than the residual plot linear model1 i.e, the model before applying transformation.This can be inferred by observing the range of y-axis in the residual plots.
#<br>
#d)
